...
d3.csv('/robot-metaphors/assets/data/tsne_data/RobotAverages.csv', function (data){
    ...
    item.on('click', function (event) {
        ...
        let table = rightContainer.append('table')
            .style("width", "100%");
        ...
        socialRow.append('td').text("Warmth: " + Math.round(data.WARMTH * 100) / 100);
        socialRow.append('td').text("Perception and Interpretation: " + Math.round(data.PERCEPTION * 100) / 100);
        ...
        let metaphorsSection = rightContainer.append('div')
            .style("display", "flex")
            .style("flex-direction", "column")
            .style("align-items", "center")
            .style("justify-content", "center")
